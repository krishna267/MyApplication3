...
public class RFduinoService extends Service {
    ...
    public final static String ACTION_CONNECTED = "com.openbci.ble.ACTION_CONNECTED";
    public final static String ACTION_DISCONNECTED = "com.openbci.ble.ACTION_DISCONNECTED";
    public final static String ACTION_DATA_AVAILABLE = "com.openbci.ble.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA = "com.openbci.ble.EXTRA_DATA";
    
    //RFDruino Characteristics
    public final static UUID UUID_SERVICE = BluetoothHelper.sixteenBitUuid(0x2220); ///service
